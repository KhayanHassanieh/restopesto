                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex space-x-8 overflow-x-auto whitespace-nowrap sm:overflow-visible">
                        ...
                        <button
                            ...
                            className={`flex-shrink-0 py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'branches' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
