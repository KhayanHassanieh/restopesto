      ...
      <main className="bg-[#f3f3f3] text-[#333] scroll-smooth">
        ...
        <section id="features" className="relative py-20 px-6 overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-end z-0 ">
            <img
              ...
              alt="Delicious food"
              className=" h-[50%] object-contain overflow-hidden"
              style={{
                position: 'absolute',
                left: '60px', // Adjust this to control how much of the plate shows
                top: '30%',
            ...
            <img
              ...
              style={{
                position: 'absolute',
                right: '60px', // Adjust this to control how much of the plate shows
        ...
        <section id="how-it-works" className="relative py-24 px-6 overflow-hidden">
          ...
          <img
            src="/UI/juice.png"
            alt=""
            className=" absolute right-10 bottom-[20px] h-[60%] object-contain drop-shadow-xl pointer-events-none "
          />
        ...
        <section id="pricing" className="relative py-24 px-6 overflow-hidden">
          ...
          <img
            src="/UI/meat.png"
            alt=""
            className=" absolute left-[130px] top-[170px] h-[35%] object-contain drop-shadow-xl pointer-events-none"
          />
          <img
            src="/UI/sushi.png"
            alt=""
            className=" absolute right-[60px] top-[600px] h-[35%] object-contain drop-shadow-xl pointer-events-none "
          />
            ...
            <div className="flex justify-center mb-10">
              <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-xl p-1 shadow-lg">
                <button
                  ...
                  className={`px-5 py-2 rounded-lg font-medium transition ${!isYearly ? 'bg-[#ffd200] text-[#333]' : 'text-[#333]'
                    }`}
                >
                  Monthly
                </button>
